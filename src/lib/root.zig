...
pub const minimum_sqlite_version_number = @import("c.zig").minimum_sqlite_version_number;
pub const sqlite_source_id = @import("c.zig").sqlite_source_id;
pub const sqlite_version = @import("c.zig").sqlite_version;
pub const sqlite_version_number = @import("c.zig").sqlite_version_number;
